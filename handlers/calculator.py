...
async def menu(callback: types.CallbackQuery, callback_data: MenuCallBack, state: FSMContext):
    ...
    if callback_data.menu_name == "about":
        await callback.message.answer(text="        Healena – это Telegram-бот, созданный, чтобы мотивировать пользователей "
                                           ...
                                           "Даниил (@CrAzY_PiZzAaA) \n• Кукушкина Ольга (@olyonka_777) \n• Данченко "
                                           "Алексей (@msby_DanLex)  \n• Герасимова Екатерина (@Pomidorchik_Rina)  "
                                           ...
                                           "\n\n  Приятного пользования! Будьте здоровы!")
