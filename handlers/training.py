...
from data_base.orm_query import orm_get_products, orm_get_product, orm_get_training, orm_get_uniducts, orm_get_trainings
            ...
            if not flag_print:
                for training in await orm_get_trainings(session):
                    ...
                    if flag and flag_detailed:
                        ...
                        k += 1
        if flag_print:
            await message.answer("Тренировки взяты с каналов Nike Training и Jordan Yeoh Fitness")
